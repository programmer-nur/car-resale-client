  ...
  const menuItems = (
    <>
      ...
      <li className="text-base font-medium p-0">
            <Link className="hover:bg-gray-100 bg-inherit w-full hover:text-blue-500 py-2 rounded-md" to="/dashboard">Dashboard</Link>
          </li>
          <li className="text-base w-full font-medium">
            <Link className="hover:bg-gray-100 bg-inherit w-full hover:text-blue-500 py-2 rounded-md" onClick={handelLogOut}>SignOut</Link>
          </li>
      </ul>
    </div>
