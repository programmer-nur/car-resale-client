    ...
    <section className="container pb-6 sm:pb-10  w-full mx-auto">
      <div className="grid md:grid-cols-4  p-6">
        ...
        >
          <img
            className="h-40 w-40"
            src="https://i.ibb.co/G5ccdL5/Integrity-300x300-1.png"
            alt=""
          />
        ...
        >
          <img
            className="h-40 w-40"
            src="https://i.ibb.co/pK329Yc/Respect-300x300-1.png"
            alt=""
          />
        ...
        >
          <img
            className="h-40 w-40"
            src="https://i.ibb.co/prSskht/Compassion-300x300-1.png"
            alt=""
          />
        ...
        >
          <img
            className="h-40 w-40"
            src="https://i.ibb.co/dBCyrp1/Excellence-300x300-1.png"
            alt=""
          />
