    ...
    <div className="max-w-xs rounded-md shadow-md bg-gray-900 text-gray-100">
      ...
      <div className="flex flex-col justify-between p-6 space-y-8">
        ...
        <div className="flex justify-center">
          <button
            onClick={() => handelAddv(product)}
            type="button"
            className="flex items-center justify-center mr-1 w-full p-3 font-semibold tracking-wide rounded-md bg-violet-400 text-gray-900"
          >
            Advg
          </button>
          <button
            onClick={() => handelDeleting(_id)}
            type="button"
